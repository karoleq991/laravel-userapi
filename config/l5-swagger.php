...
return [
    ...
    'defaults' => [
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_LOCALHOST' => env('L5_SWAGGER_CONST_LOCALHOST', 'http://localhost:8000/api/'),
            'L5_SWAGGER_CONST_TESTINGHOST' => env('L5_SWAGGER_CONST_TESTINGHOST', 'http://localhost:8000/api/'),
        ],
    ],
];
